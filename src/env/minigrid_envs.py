...
from gym_minigrid.envs import DoorKeyEnv, MultiRoomEnv, KeyCorridor, FourRoomsEnv, ObstructedMazeEnv
...
class DoorKeyEnv11x11(DoorKeyEnv):
    def __init__(self):
...
register(
    ...
    entry_point=f'src.env.minigrid_envs:DoorKeyEnv7x7'
)
register(
    id='MiniGrid-DoorKey-11x11-v0',
    entry_point=f'src.env.minigrid_envs:DoorKeyEnv11x11'
)
register(
    id='MiniGrid-DoorKey-12x12-v0',
    entry_point=f'src.env.minigrid_envs:DoorKeyEnv12x12'
)
register(
    id='MiniGrid-DoorKey-32x32-v0',
    entry_point=f'src.env.minigrid_envs:DoorKeyEnv32x32'
)
...
class DoorKeyEnv7x7ViewSize9x9(CustomDoorKeyEnv):
    def __init__(self):
        super().__init__(size=7, agent_view_size=9)

class DoorKeyEnv7x7ViewSize5x5(CustomDoorKeyEnv):
    def __init__(self):
        super().__init__(size=7, agent_view_size=5)

class DoorKeyEnv7x7ViewSize3x3(CustomDoorKeyEnv):
    def __init__(self):
        super().__init__(size=7, agent_view_size=3)
...
class DoorKeyEnv11x11ViewSize9x9(CustomDoorKeyEnv):
    def __init__(self):
        super().__init__(size=11, agent_view_size=9)

class DoorKeyEnv11x11ViewSize5x5(CustomDoorKeyEnv):
    def __init__(self):
        super().__init__(size=11, agent_view_size=5)


class DoorKeyEnv11x11ViewSize3x3(CustomDoorKeyEnv):
    def __init__(self):
        super().__init__(size=11, agent_view_size=3)


class DoorKeyEnv16x16ViewSize15x15(CustomDoorKeyEnv):
    def __init__(self):
        super().__init__(size=16, agent_view_size=15)


class DoorKeyEnv16x16ViewSize13x13(CustomDoorKeyEnv):
    def __init__(self):
        super().__init__(size=16, agent_view_size=13)


class DoorKeyEnv16x16ViewSize11x11(CustomDoorKeyEnv):
    def __init__(self):
...
class DoorKeyEnv24x24ViewSize9x9(CustomDoorKeyEnv):
    def __init__(self):
        super().__init__(size=24, agent_view_size=9)


class DoorKeyEnv24x24ViewSize5x5(CustomDoorKeyEnv):
    def __init__(self):
        super().__init__(size=24, agent_view_size=5)
...
class DoorKeyEnv11x11ViewSize5x5MaxStep490(CustomDoorKeyEnv):
    def __init__(self):
        super().__init__(size=11, agent_view_size=5, max_steps=490)

class DoorKeyEnv16x16ViewSize5x5MaxStep490(CustomDoorKeyEnv):
    def __init__(self):
        super().__init__(size=16, agent_view_size=5, max_steps=490)
        
class DoorKeyEnv32x32ViewSize5x5MaxStep490(CustomDoorKeyEnv):
    def __init__(self):
        super().__init__(size=32, agent_view_size=5, max_steps=490)

class DoorKeyEnv32x32ViewSize5x5MaxStep2560(CustomDoorKeyEnv):
    def __init__(self):
        super().__init__(size=32, agent_view_size=5, max_steps=2560)

class DoorKeyEnv16x16ViewSize9x9MaxStep490(CustomDoorKeyEnv):
    def __init__(self):
        super().__init__(size=16, agent_view_size=9, max_steps=490)

class DoorKeyEnv16x16ViewSize5x5MaxStep1000(CustomDoorKeyEnv):
    def __init__(self):
        super().__init__(size=16, agent_view_size=5, max_steps=1000)

class DoorKeyEnv11x11ViewSize5x5MaxStep2048(CustomDoorKeyEnv):
    def __init__(self):
        super().__init__(size=11, agent_view_size=5, max_steps=2048)


class DoorKeyEnv16x16MaxStep500NoPenalty(CustomDoorKeyEnv):
    def __init__(self):
        super().__init__(size=16, agent_view_size=7, max_steps=500, disable_penalty=True)
class DoorKeyEnv16x16MaxStep1kNoPenalty(CustomDoorKeyEnv):
    def __init__(self):
        super().__init__(size=16, agent_view_size=7, max_steps=1000, disable_penalty=True)
class DoorKeyEnv16x16MaxStep2kNoPenalty(CustomDoorKeyEnv):
    def __init__(self):
        super().__init__(size=16, agent_view_size=7, max_steps=2000, disable_penalty=True)
class DoorKeyEnv16x16MaxStep3kNoPenalty(CustomDoorKeyEnv):
    def __init__(self):
        super().__init__(size=16, agent_view_size=7, max_steps=3000, disable_penalty=True)
class DoorKeyEnv16x16MaxStep4kNoPenalty(CustomDoorKeyEnv):
    def __init__(self):
        super().__init__(size=16, agent_view_size=7, max_steps=4000, disable_penalty=True)
class DoorKeyEnv16x16MaxStep5kNoPenalty(CustomDoorKeyEnv):
    def __init__(self):
        super().__init__(size=16, agent_view_size=7, max_steps=5000, disable_penalty=True)
class DoorKeyEnv16x16MaxStep6kNoPenalty(CustomDoorKeyEnv):
    def __init__(self):
        super().__init__(size=16, agent_view_size=7, max_steps=6000, disable_penalty=True)
class DoorKeyEnv16x16MaxStep7kNoPenalty(CustomDoorKeyEnv):
    def __init__(self):
        super().__init__(size=16, agent_view_size=7, max_steps=7000, disable_penalty=True)
class DoorKeyEnv16x16MaxStep8kNoPenalty(CustomDoorKeyEnv):
    def __init__(self):
        super().__init__(size=16, agent_view_size=7, max_steps=8000, disable_penalty=True)


register(
    id='MiniGrid-DoorKey-7x7-ViewSize-9x9-v0',
    entry_point=f'src.env.minigrid_envs:DoorKeyEnv7x7ViewSize9x9'
)
register(
    id='MiniGrid-DoorKey-7x7-ViewSize-5x5-v0',
    entry_point=f'src.env.minigrid_envs:DoorKeyEnv7x7ViewSize5x5'
)
register(
    id='MiniGrid-DoorKey-7x7-ViewSize-3x3-v0',
    entry_point=f'src.env.minigrid_envs:DoorKeyEnv7x7ViewSize3x3'
)

register(
    id='MiniGrid-DoorKey-8x8-ViewSize-9x9-v0',
    entry_point=f'src.env.minigrid_envs:DoorKeyEnv8x8ViewSize9x9'
)
register(
    id='MiniGrid-DoorKey-8x8-ViewSize-5x5-v0',
    entry_point=f'src.env.minigrid_envs:DoorKeyEnv8x8ViewSize5x5'
)
register(
    id='MiniGrid-DoorKey-8x8-ViewSize-3x3-v0',
    entry_point=f'src.env.minigrid_envs:DoorKeyEnv8x8ViewSize3x3'
)

register(
    id='MiniGrid-DoorKey-11x11-ViewSize-9x9-v0',
    entry_point=f'src.env.minigrid_envs:DoorKeyEnv11x11ViewSize9x9'
)

register(
    id='MiniGrid-DoorKey-11x11-ViewSize-5x5-v0',
    entry_point=f'src.env.minigrid_envs:DoorKeyEnv11x11ViewSize5x5'
)

register(
    id='MiniGrid-DoorKey-11x11-ViewSize-3x3-v0',
    entry_point=f'src.env.minigrid_envs:DoorKeyEnv11x11ViewSize3x3'
)

register(
    id='MiniGrid-DoorKey-16x16-ViewSize-15x15-v0',
    entry_point=f'src.env.minigrid_envs:DoorKeyEnv16x16ViewSize15x15'
)

register(
    id='MiniGrid-DoorKey-16x16-ViewSize-13x13-v0',
    entry_point=f'src.env.minigrid_envs:DoorKeyEnv16x16ViewSize13x13'
)

register(
    id='MiniGrid-DoorKey-16x16-ViewSize-11x11-v0',
    entry_point=f'src.env.minigrid_envs:DoorKeyEnv16x16ViewSize11x11'
)

register(
    id='MiniGrid-DoorKey-16x16-ViewSize-9x9-v0',
    entry_point=f'src.env.minigrid_envs:DoorKeyEnv16x16ViewSize9x9'
)

register(
    id='MiniGrid-DoorKey-16x16-ViewSize-5x5-v0',
    entry_point=f'src.env.minigrid_envs:DoorKeyEnv16x16ViewSize5x5'
)

register(
    id='MiniGrid-DoorKey-11x11-ViewSize-5x5-MaxStep-490-v0',
    entry_point=f'src.env.minigrid_envs:DoorKeyEnv11x11ViewSize5x5MaxStep490'
)
register(
    id='MiniGrid-DoorKey-16x16-ViewSize-5x5-MaxStep-490-v0',
    entry_point=f'src.env.minigrid_envs:DoorKeyEnv16x16ViewSize5x5MaxStep490'
)
register(
    id='MiniGrid-DoorKey-16x16-ViewSize-5x5-MaxStep-1000-v0',
    entry_point=f'src.env.minigrid_envs:DoorKeyEnv16x16ViewSize5x5MaxStep1000'
)
register(
    id='MiniGrid-DoorKey-11x11-ViewSize-5x5-MaxStep-2048-v0',
    entry_point=f'src.env.minigrid_envs:DoorKeyEnv11x11ViewSize5x5MaxStep2048'
)
register(
    id='MiniGrid-DoorKey-16x16-ViewSize-9x9-MaxStep-490-v0',
    entry_point=f'src.env.minigrid_envs:DoorKeyEnv16x16ViewSize9x9MaxStep490'
)

register(
    id='MiniGrid-DoorKey-16x16-ViewSize-3x3-v0',
    entry_point=f'src.env.minigrid_envs:DoorKeyEnv16x16ViewSize3x3'
)

register(
    id='MiniGrid-DoorKey-24x24-ViewSize-9x9-v0',
    entry_point=f'src.env.minigrid_envs:DoorKeyEnv24x24ViewSize9x9'
)

register(
    id='MiniGrid-DoorKey-24x24-ViewSize-5x5-v0',
    entry_point=f'src.env.minigrid_envs:DoorKeyEnv24x24ViewSize5x5'
)

register(
    id='MiniGrid-DoorKey-32x32-ViewSize-9x9-v0',
    entry_point=f'src.env.minigrid_envs:DoorKeyEnv32x32ViewSize9x9'
)

register(
    id='MiniGrid-DoorKey-32x32-ViewSize-3x3-v0',
    entry_point=f'src.env.minigrid_envs:DoorKeyEnv32x32ViewSize3x3'
)
register(
    id='MiniGrid-DoorKey-32x32-ViewSize-5x5-v0',
    entry_point=f'src.env.minigrid_envs:DoorKeyEnv32x32ViewSize5x5'
)
register(
    id='MiniGrid-DoorKey-32x32-ViewSize-5x5-MaxStep-490-v0',
    entry_point=f'src.env.minigrid_envs:DoorKeyEnv32x32ViewSize5x5MaxStep490'
)
register(
    id='MiniGrid-DoorKey-32x32-ViewSize-5x5-MaxStep-2560-v0',
    entry_point=f'src.env.minigrid_envs:DoorKeyEnv32x32ViewSize5x5MaxStep2560'
)

register(
    id='MiniGrid-DoorKey-16x16-MaxStep-500-NoPenalty-v0',
    entry_point=f'src.env.minigrid_envs:DoorKeyEnv16x16MaxStep500NoPenalty'
)
register(
    id='MiniGrid-DoorKey-16x16-MaxStep-1k-NoPenalty-v0',
    entry_point=f'src.env.minigrid_envs:DoorKeyEnv16x16MaxStep1kNoPenalty'
)
register(
    id='MiniGrid-DoorKey-16x16-MaxStep-2k-NoPenalty-v0',
    entry_point=f'src.env.minigrid_envs:DoorKeyEnv16x16MaxStep2kNoPenalty'
)
register(
    id='MiniGrid-DoorKey-16x16-MaxStep-3k-NoPenalty-v0',
    entry_point=f'src.env.minigrid_envs:DoorKeyEnv16x16MaxStep3kNoPenalty'
)
register(
    id='MiniGrid-DoorKey-16x16-MaxStep-4k-NoPenalty-v0',
    entry_point=f'src.env.minigrid_envs:DoorKeyEnv16x16MaxStep4kNoPenalty'
)
register(
    id='MiniGrid-DoorKey-16x16-MaxStep-5k-NoPenalty-v0',
    entry_point=f'src.env.minigrid_envs:DoorKeyEnv16x16MaxStep5kNoPenalty'
)
register(
    id='MiniGrid-DoorKey-16x16-MaxStep-6k-NoPenalty-v0',
    entry_point=f'src.env.minigrid_envs:DoorKeyEnv16x16MaxStep6kNoPenalty'
)
register(
    id='MiniGrid-DoorKey-16x16-MaxStep-7k-NoPenalty-v0',
    entry_point=f'src.env.minigrid_envs:DoorKeyEnv16x16MaxStep7kNoPenalty'
)
register(
    id='MiniGrid-DoorKey-16x16-MaxStep-8k-NoPenalty-v0',
    entry_point=f'src.env.minigrid_envs:DoorKeyEnv16x16MaxStep8kNoPenalty'
)
...
register(
    ...
    entry_point=f'src.env.minigrid_envs:KeyCorridorS6R3V5'
)

register(
    id='MiniGrid-KeyCorridorS6R3V3-v0',
    entry_point=f'src.env.minigrid_envs:KeyCorridorS6R3V3'
)
register(
    id='MiniGrid-KeyCorridorS8R4-v0',
    entry_point=f'src.env.minigrid_envs:KeyCorridorS8R4'
)
register(
    id='MiniGrid-KeyCorridorS10R5-v0',
    entry_point=f'src.env.minigrid_envs:KeyCorridorS10R5'
)
register(
    id='MiniGrid-KeyCorridorS12R6-v0',
    entry_point=f'src.env.minigrid_envs:KeyCorridorS12R6'
)


class CusromFourRooms(MiniGridEnv):
...
class FourRoomsViewSize5x5(CusromFourRooms):
    def __init__(self):
        super().__init__(agent_view_size=5)

class FourRoomsViewSize3x3(CusromFourRooms):
    def __init__(self):
...
class MultiRoomEnvN6V5(CustomMultiRoomEnv):
    def __init__(self):
        super().__init__(
            minNumRooms=6,
            maxNumRooms=6,
...
register(
    id='MiniGrid-MultiRoom-N6-ViewSize-5x5-v0',
    entry_point='src.env.minigrid_envs:MultiRoomEnvN6V5'
)
register(
