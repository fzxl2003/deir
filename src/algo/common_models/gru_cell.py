...
class CustomGRUCell(RNNCellBase):
    ...
    def __init__(self,
        ...
        self.norm_i = get_norm_layer_1d(norm_type, hidden_size * 3)
        self.norm_h = get_norm_layer_1d(norm_type, hidden_size * 3)
        self.norm_n = get_norm_layer_1d(norm_type, hidden_size)
